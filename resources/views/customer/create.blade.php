                ...
                <div class="max-w-xl">
                    <form method="POST" action="{{ route('customer.store') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="identity" class="block mt-1 w-full" type="text" name="identity" :value="old('identity')" required />
                        ...
                        <div class="mt-4">
                            ...
                            <div class="flex space-x-2 mt-2 items-center">
                                <div class="flex items-center space-x-1">
                                    <input type="radio" id="male" name="gender" value="M" {{ old('gender') != 'F' ? 'checked' : '' }} />
